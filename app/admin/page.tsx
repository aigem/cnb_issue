...
// useRouter and useToast are no longer needed directly here if only used for logout
...
export default function AdminPage() {
  ...
  // The malformed object literal that was here has been removed.
  // The return statement below is the correct one for the component.
  return (
